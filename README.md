...
A modular sports betting arbitrage detection platform that compares odds across sportsbooks and prediction markets.

## Features

- **Three Arbitrage Detection Algorithms**
...
- **Comprehensive Data Storage**
  - SQLite database with optimized indices for arbitrage queries
...
| `config.yaml` | Per-source polling config, sports, bookmakers |
| `schema.sql` | SQLite schema with arbitrage-optimized indices |
